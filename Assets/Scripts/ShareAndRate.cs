...
public class ShareAndRate : MonoBehaviour
{
    ...
    string subject = "JumpyJump";

    string body = "Let's play together https://play.google.com/store/apps/details?id=com.YumaApps.JumpyJump";
#if UNITY_IPHONE
 ...
 private static extern void sampleTextMethod (string message);
  ...
  sampleTextMethod (shareMessage);
    ...
    {
#if UNITY_ANDROID
        Application.OpenURL("https://play.google.com/store/apps/details?id=com.YumaApps.JumpyJump");
#elif UNITY_IPHONE
  Application.OpenURL("itms-apps://itunes.apple.com/app/idYOUR_ID");
    ...
    {
        string Mail = "yumaappsofficial@gmail.com";
